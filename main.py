...
class CyberGuardianApp(ctk.CTk):
    ...
    def create_header(self):
        ...
        ctk.CTkLabel(header, text="CyberGuardian Pro", font=ctk.CTkFont(size=28, weight="bold")).pack(side="left", padx=20, pady=20)
        
        quick_frame = ctk.CTkFrame(header, fg_color="transparent")
        quick_frame.pack(side="right", padx=20)
        
        ctk.CTkButton(quick_frame, text="PANIC", fg_color="#dc3545", width=100, command=self.panic_stop).pack(side="right", padx=5)
    ...
    def create_sidebar(self):
        ...
        for text, command in nav_items:
            btn = ctk.CTkButton(self.sidebar, text=text, anchor="w", command=command, fg_color="transparent", height=40)
            btn.pack(fill="x", padx=10, pady=2)
            self.nav_buttons[text] = btn
            
        info_frame = ctk.CTkFrame(self.sidebar)
        info_frame.pack(side="bottom", fill="x", padx=10, pady=10)
        ctk.CTkLabel(info_frame, text="System Info", font=ctk.CTkFont(weight="bold")).pack(pady=5)
        ctk.CTkLabel(info_frame, text=self.get_system_info(), justify="left", font=ctk.CTkFont(size=10)).pack(pady=5)
    ...
    def create_statusbar(self):
        ...
        self.time_label = ctk.CTkLabel(self.statusbar, text=datetime.now().strftime("%H:%M:%S"))
    ...
    def show_dashboard(self):
        ...
        ctk.CTkLabel(dashboard, text="Security Dashboard", font=ctk.CTkFont(size=24, weight="bold")).pack(pady=10)
        
        cards = [("CPU", f"{psutil.cpu_percent()}%"), ("RAM", f"{psutil.virtual_memory().percent}%"), 
                 ("Disk", f"{psutil.disk_usage('/').percent}%"), ("Prozesse", str(len(psutil.pids())))]
        
        for i, (title, value) in enumerate(cards):
            card = ctk.CTkFrame(dashboard, width=150, height=80)
            card.grid(row=0, column=i, padx=10, pady=5)
            ctk.CTkLabel(card, text=title).pack(pady=(10, 5))
            ctk.CTkLabel(card, text=value, font=ctk.CTkFont(size=18, weight="bold")).pack(pady=5)
            
        ctk.CTkButton(dashboard, text="Quick Scan", command=self.quick_scan).pack(pady=20)
    ...
    def show_network(self):
        ...
        ctk.CTkLabel(frame, text="Netzwerk-Scanner", font=ctk.CTkFont(size=24, weight="bold")).pack(pady=10)
        ctk.CTkButton(frame, text="Netzwerk scannen", command=self.start_network_scan).pack(pady=10)
        self.network_tree = ttk.Treeview(frame, columns=("IP", "MAC", "Hostname"), show="headings")
    ...
    def _update_tree(self, devices):
        ...
        for d in devices:
            self.network_tree.insert("", "end", values=(d.get("ip", ""), d.get("mac", ""), d.get("hostname", "")))
    ...
    def show_wifi(self):
        ...
        frame = ctk.CTkScrollableFrame(self.main_area)
        frame.pack(fill="both", expand=True, padx=10, pady=10)
        ctk.CTkLabel(frame, text="WLAN-Audit", font=ctk.CTkFont(size=24, weight="bold")).pack(pady=10)
        ctk.CTkButton(frame, text="Netzwerke scannen", command=self.scan_wifi).pack(pady=10)
    ...
    def show_ports(self):
        ...
        frame = ctk.CTkScrollableFrame(self.main_area)
        frame.pack(fill="both", expand=True, padx=10, pady=10)
        ctk.CTkLabel(frame, text="Port-Manager", font=ctk.CTkFont(size=24, weight="bold")).pack(pady=10)
        ctk.CTkButton(frame, text="Ports anzeigen", command=self.load_ports).pack(pady=10)
        self.port_tree = ttk.Treeview(frame, columns=("Port", "PID", "Prozess"), show="headings")
    ...
    def load_ports(self):
        if MODULES_AVAILABLE:
            ...
            for p in ports[:30]:
                self.port_tree.insert("", "end", values=(p['port'], p['pid'], p['process']))
    ...
    def show_processes(self):
        ...
        frame = ctk.CTkScrollableFrame(self.main_area)
        frame.pack(fill="both", expand=True, padx=10, pady=10)
        ctk.CTkLabel(frame, text="Prozesse", font=ctk.CTkFont(size=24, weight="bold")).pack(pady=10)
        self.proc_tree = ttk.Treeview(frame, columns=("PID", "Name", "CPU"), show="headings")
    ...
    def refresh_procs(self):
        if MODULES_AVAILABLE:
            ...
            for p in procs[:30]:
                self.proc_tree.insert("", "end", values=(p['pid'], p['name'], f"{p['cpu']:.1f}"))
    ...
    def show_wireguard(self):
        ...
        frame = ctk.CTkScrollableFrame(self.main_area)
        frame.pack(fill="both", expand=True, padx=10, pady=10)
        ctk.CTkLabel(frame, text="WireGuard VPN", font=ctk.CTkFont(size=24, weight="bold")).pack(pady=10)
        ctk.CTkButton(frame, text="Keys generieren", command=self.gen_keys).pack(pady=10)
    ...
    def show_anonymizer(self):
        ...
        frame = ctk.CTkScrollableFrame(self.main_area)
        frame.pack(fill="both", expand=True, padx=10, pady=10)
        ctk.CTkLabel(frame, text="Anonymisierung", font=ctk.CTkFont(size=24, weight="bold")).pack(pady=10)
    ...
    def show_router(self):
        ...
        frame = ctk.CTkScrollableFrame(self.main_area)
        frame.pack(fill="both", expand=True, padx=10, pady=10)
        ctk.CTkLabel(frame, text="Router-Tools", font=ctk.CTkFont(size=24, weight="bold")).pack(pady=10)
    ...
    def show_ids(self):
        ...
        frame = ctk.CTkScrollableFrame(self.main_area)
        frame.pack(fill="both", expand=True, padx=10, pady=10)
        ctk.CTkLabel(frame, text="IDS/IPS", font=ctk.CTkFont(size=24, weight="bold")).pack(pady=10)
    ...
    def show_integrity(self):
        ...
        frame = ctk.CTkScrollableFrame(self.main_area)
        frame.pack(fill="both", expand=True, padx=10, pady=10)
        ctk.CTkLabel(frame, text="Datei-Integritaet", font=ctk.CTkFont(size=24, weight="bold")).pack(pady=10)
    ...
    def show_forensics(self):
        ...
        frame = ctk.CTkScrollableFrame(self.main_area)
        frame.pack(fill="both", expand=True, padx=10, pady=10)
        ctk.CTkLabel(frame, text="Forensik", font=ctk.CTkFont(size=24, weight="bold")).pack(pady=10)
    ...
    def show_rollback(self):
        ...
        frame = ctk.CTkScrollableFrame(self.main_area)
        frame.pack(fill="both", expand=True, padx=10, pady=10)
        ctk.CTkLabel(frame, text="Rollback", font=ctk.CTkFont(size=24, weight="bold")).pack(pady=10)
    ...
    def show_logs(self):
        ...
        frame.pack(fill="both", expand=True, padx=10, pady=10)
        ctk.CTkLabel(frame, text="Logs", font=ctk.CTkFont(size=24, weight="bold")).pack(pady=10)
    ...
    def show_settings(self):
        ...
        frame = ctk.CTkScrollableFrame(self.main_area)
        frame.pack(fill="both", expand=True, padx=10, pady=10)
        ctk.CTkLabel(frame, text="Einstellungen", font=ctk.CTkFont(size=24, weight="bold")).pack(pady=10)
